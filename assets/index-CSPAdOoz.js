 ...
 */var Bp;function pv(){if(Bp)return we;Bp=1;var i=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),c=Symbol.for("react.provider"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),_=Symbol.for("react.suspense"),E=Symbol.for("react.memo"),C=Symbol.for("react.lazy"),D=Symbol.iterator;function M(x){return x===null||typeof x!="object"?null:(x=D&&x[D]||x["@@iterator"],typeof x=="function"?x:null)}var Q={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},X=Object.assign,Z={};function J(x,j,ae){this.props=x,this.context=j,this.refs=Z,this.updater=ae||Q}J.prototype.isReactComponent={},J.prototype.setState=function(x,j){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,j,"setState")},J.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function ye(){}ye.prototype=J.prototype;function pe(x,j,ae){this.props=x,this.context=j,this.refs=Z,this.updater=ae||Q}var me=pe.prototype=new ye;me.constructor=pe,X(me,J.prototype),me.isPureReactComponent=!0;var ke=Array.isArray,tt=Object.prototype.hasOwnProperty,Oe={current:null},P={key:!0,ref:!0,__self:!0,__source:!0};function T(x,j,ae){var _e,Ee={},Se=null,Ne=null;if(j!=null)for(_e in j.ref!==void 0&&(Ne=j.ref),j.key!==void 0&&(Se=""+j.key),j)tt.call(j,_e)&&!P.hasOwnProperty(_e)&&(Ee[_e]=j[_e]);var De=arguments.length-2;if(De===1)Ee.children=ae;else if(1<De){for(var Ue=Array(De),ht=0;ht<De;ht++)Ue[ht]=arguments[ht+2];Ee.children=Ue}if(x&&x.defaultProps)for(_e in De=x.defaultProps,De)Ee[_e]===void 0&&(Ee[_e]=De[_e]);return{$$typeof:i,type:x,key:Se,ref:Ne,props:Ee,_owner:Oe.current}}function S(x,j){return{$$typeof:i,type:x.type,key:j,ref:x.ref,props:x.props,_owner:x._owner}}function k(x){return typeof x=="object"&&x!==null&&x.$$typeof===i}function N(x){var j={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(ae){return j[ae]})}var O=/\/+/g;function I(x,j){return typeof x=="object"&&x!==null&&x.key!=null?N(""+x.key):j.toString(36)}function Je(x,j,ae,_e,Ee){var Se=typeof x;(Se==="undefined"||Se==="boolean")&&(x=null);var Ne=!1;if(x===null)Ne=!0;else switch(Se){case"string":case"number":Ne=!0;break;case"object":switch(x.$$typeof){case i:case e:Ne=!0}}if(Ne)return Ne=x,Ee=Ee(Ne),x=_e===""?"."+I(Ne,0):_e,ke(Ee)?(ae="",x!=null&&(ae=x.replace(O,"$&/")+"/"),Je(Ee,j,ae,"",function(ht){return ht})):Ee!=null&&(k(Ee)&&(Ee=S(Ee,ae+(!Ee.key||Ne&&Ne.key===Ee.key?"":(""+Ee.key).replace(O,"$&/")+"/")+x)),j.push(Ee)),1;if(Ne=0,_e=_e===""?".":_e+":",ke(x))for(var De=0;De<x.length;De++){Se=x[De];var Ue=_e+I(Se,De);Ne+=Je(Se,j,ae,Ue,Ee)}else if(Ue=M(x),typeof Ue=="function")for(x=Ue.call(x),De=0;!(Se=x.next()).done;)Se=Se.value,Ue=_e+I(Se,De++),Ne+=Je(Se,j,ae,Ue,Ee);else if(Se==="object")throw j=String(x),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.");return Ne}function Ct(x,j,ae){if(x==null)return x;var _e=[],Ee=0;return Je(x,_e,"","",function(Se){return j.call(ae,Se,Ee++)}),_e}function Rt(x){if(x._status===-1){var j=x._result;j=j(),j.then(function(ae){(x._status===0||x._status===-1)&&(x._status=1,x._result=ae)},function(ae){(x._status===0||x._status===-1)&&(x._status=2,x._result=ae)}),x._status===-1&&(x._status=0,x._result=j)}if(x._status===1)return x._result.default;throw x._result}var Le={current:null},Y={transition:null},le={ReactCurrentDispatcher:Le,ReactCurrentBatchConfig:Y,ReactCurrentOwner:Oe};function te(){throw Error("act(...) is not supported in production builds of React.")}return we.Children={map:Ct,forEach:function(x,j,ae){Ct(x,function(){j.apply(this,arguments)},ae)},count:function(x){var j=0;return Ct(x,function(){j++}),j},toArray:function(x){return Ct(x,function(j){return j})||[]},only:function(x){if(!k(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},we.Component=J,we.Fragment=n,we.Profiler=a,we.PureComponent=pe,we.StrictMode=s,we.Suspense=_,we.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=le,we.act=te,we.cloneElement=function(x,j,ae){if(x==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+x+".");var _e=X({},x.props),Ee=x.key,Se=x.ref,Ne=x._owner;if(j!=null){if(j.ref!==void 0&&(Se=j.ref,Ne=Oe.current),j.key!==void 0&&(Ee=""+j.key),x.type&&x.type.defaultProps)var De=x.type.defaultProps;for(Ue in j)tt.call(j,Ue)&&!P.hasOwnProperty(Ue)&&(_e[Ue]=j[Ue]===void 0&&De!==void 0?De[Ue]:j[Ue])}var Ue=arguments.length-2;if(Ue===1)_e.children=ae;else if(1<Ue){De=Array(Ue);for(var ht=0;ht<Ue;ht++)De[ht]=arguments[ht+2];_e.children=De}return{$$typeof:i,type:x.type,key:Ee,ref:Se,props:_e,_owner:Ne}},we.createContext=function(x){return x={$$typeof:p,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},x.Provider={$$typeof:c,_context:x},x.Consumer=x},we.createElement=T,we.createFactory=function(x){var j=T.bind(null,x);return j.type=x,j},we.createRef=function(){return{current:null}},we.forwardRef=function(x){return{$$typeof:g,render:x}},we.isValidElement=k,we.lazy=function(x){return{$$typeof:C,_payload:{_status:-1,_result:x},_init:Rt}},we.memo=function(x,j){return{$$typeof:E,type:x,compare:j===void 0?null:j}},we.startTransition=function(x){var j=Y.transition;Y.transition={};try{x()}finally{Y.transition=j}},we.unstable_act=te,we.useCallback=function(x,j){return Le.current.useCallback(x,j)},we.useContext=function(x){return Le.current.useContext(x)},we.useDebugValue=function(){},we.useDeferredValue=function(x){return Le.current.useDeferredValue(x)},we.useEffect=function(x,j){return Le.current.useEffect(x,j)},we.useId=function(){return Le.current.useId()},we.useImperativeHandle=function(x,j,ae){return Le.current.useImperativeHandle(x,j,ae)},we.useInsertionEffect=function(x,j){return Le.current.useInsertionEffect(x,j)},we.useLayoutEffect=function(x,j){return Le.current.useLayoutEffect(x,j)},we.useMemo=function(x,j){return Le.current.useMemo(x,j)},we.useReducer=function(x,j,ae){return Le.current.useReducer(x,j,ae)},we.useRef=function(x){return Le.current.useRef(x)},we.useState=function(x){return Le.current.useState(x)},we.useSyncExternalStore=function(x,j,ae){return Le.current.useSyncExternalStore(x,j,ae)},we.useTransition=function(){return Le.current.useTransition()},we.version="18.3.1",we}var $p;function Zh(){return $p||($p=1,yh.exports=pv()),yh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hp;function mv(){if(Hp)return sa;Hp=1;var i=Zh(),e=Symbol.for("react.element"),n=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,a=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,c={key:!0,ref:!0,__self:!0,__source:!0};function p(g,_,E){var C,D={},M=null,Q=null;E!==void 0&&(M=""+E),_.key!==void 0&&(M=""+_.key),_.ref!==void 0&&(Q=_.ref);for(C in _)s.call(_,C)&&!c.hasOwnProperty(C)&&(D[C]=_[C]);if(g&&g.defaultProps)for(C in _=g.defaultProps,_)D[C]===void 0&&(D[C]=_[C]);return{$$typeof:e,type:g,key:M,ref:Q,props:D,_owner:a.current}}return sa.Fragment=n,sa.jsx=p,sa.jsxs=p,sa}var Wp;function gv(){return Wp||(Wp=1,gh.exports=mv()),gh.exports}var G=gv(),ji=Zh(),Xl={},_h={exports:{}},Kt={},vh={exports:{}},Eh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qp;function yv(){return qp||(qp=1,(function(i){function e(Y,le){var te=Y.length;Y.push(le);e:for(;0<te;){var x=te-1>>>1,j=Y[x];if(0<a(j,le))Y[x]=le,Y[te]=j,te=x;else break e}}function n(Y){return Y.length===0?null:Y[0]}function s(Y){if(Y.length===0)return null;var le=Y[0],te=Y.pop();if(te!==le){Y[0]=te;e:for(var x=0,j=Y.length,ae=j>>>1;x<ae;){var _e=2*(x+1)-1,Ee=Y[_e],Se=_e+1,Ne=Y[Se];if(0>a(Ee,te))Se<j&&0>a(Ne,Ee)?(Y[x]=Ne,Y[Se]=te,x=Se):(Y[x]=Ee,Y[_e]=te,x=_e);else if(Se<j&&0>a(Ne,te))Y[x]=Ne,Y[Se]=te,x=Se;else break e}}return le}function a(Y,le){var te=Y.sortIndex-le.sortIndex;return te!==0?te:Y.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var c=performance;i.unstable_now=function(){return c.now()}}else{var p=Date,g=p.now();i.unstable_now=function(){return p.now()-g}}var _=[],E=[],C=1,D=null,M=3,Q=!1,X=!1,Z=!1,J=typeof setTimeout=="function"?setTimeout:null,ye=typeof clearTimeout=="function"?clearTimeout:null,pe=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function me(Y){for(var le=n(E);le!==null;){if(le.callback===null)s(E);else if(le.startTime<=Y)s(E),le.sortIndex=le.expirationTime,e(_,le);else break;le=n(E)}}function ke(Y){if(Z=!1,me(Y),!X)if(n(_)!==null)X=!0,Rt(tt);else{var le=n(E);le!==null&&Le(ke,le.startTime-Y)}}function tt(Y,le){X=!1,Z&&(Z=!1,ye(T),T=-1),Q=!0;var te=M;try{for(me(le),D=n(_);D!==null&&(!(D.expirationTime>le)||Y&&!N());){var x=D.callback;if(typeof x=="function"){D.callback=null,M=D.priorityLevel;var j=x(D.expirationTime<=le);le=i.unstable_now(),typeof j=="function"?D.callback=j:D===n(_)&&s(_),me(le)}else s(_);D=n(_)}if(D!==null)var ae=!0;else{var _e=n(E);_e!==null&&Le(ke,_e.startTime-le),ae=!1}return ae}finally{D=null,M=te,Q=!1}}var Oe=!1,P=null,T=-1,S=5,k=-1;function N(){return!(i.unstable_now()-k<S)}function O(){if(P!==null){var Y=i.unstable_now();k=Y;var le=!0;try{le=P(!0,Y)}finally{le?I():(Oe=!1,P=null)}}else Oe=!1}var I;if(typeof pe=="function")I=function(){pe(O)};else if(typeof MessageChannel<"u"){var Je=new MessageChannel,Ct=Je.port2;Je.port1.onmessage=O,I=function(){Ct.postMessage(null)}}else I=function(){J(O,0)};function Rt(Y){P=Y,Oe||(Oe=!0,I())}function Le(Y,le){T=J(function(){Y(i.unstable_now())},le)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(Y){Y.callback=null},i.unstable_continueExecution=function(){X||Q||(X=!0,Rt(tt))},i.unstable_forceFrameRate=function(Y){0>Y||125<Y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<Y?Math.floor(1e3/Y):5},i.unstable_getCurrentPriorityLevel=function(){return M},i.unstable_getFirstCallbackNode=function(){return n(_)},i.unstable_next=function(Y){switch(M){case 1:case 2:case 3:var le=3;break;default:le=M}var te=M;M=le;try{return Y()}finally{M=te}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(Y,le){switch(Y){case 1:case 2:case 3:case 4:case 5:break;default:Y=3}var te=M;M=Y;try{return le()}finally{M=te}},i.unstable_scheduleCallback=function(Y,le,te){var x=i.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?x+te:x):te=x,Y){case 1:var j=-1;break;case 2:j=250;break;case 5:j=1073741823;break;case 4:j=1e4;break;default:j=5e3}return j=te+j,Y={id:C++,callback:le,priorityLevel:Y,startTime:te,expirationTime:j,sortIndex:-1},te>x?(Y.sortIndex=te,e(E,Y),n(_)===null&&Y===n(E)&&(Z?(ye(T),T=-1):Z=!0,Le(ke,te-x))):(Y.sortIndex=j,e(_,Y),X||Q||(X=!0,Rt(tt))),Y},i.unstable_shouldYield=N,i.unstable_wrapCallback=function(Y){var le=M;return function(){var te=M;M=le;try{return Y.apply(this,arguments)}finally{M=te}}}})(Eh)),Eh}var Gp;function _v(){return Gp||(Gp=1,vh.exports=yv()),vh.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nv=()=>Pv().__FIREBASE_DEFAULTS__,Dv=()=>{if(typeof process>"u"||typeof Jp>"u")return;const i=Jp.__FIREBASE_DEFAULTS__;if(i)return JSON.parse(i)},xv=()=>{if(typeof document>"u")return;let i;try{i=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=i&&mg(i[1]);return e&&JSON.parse(e)},Ou=()=>{try{return Av()||Nv()||Dv()||xv()}catch(i){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${i}`);return}},gg=i=>Ou()?.emulatorHosts?.[i],Ov=i=>{const e=gg(i);if(!e)return;const n=e.lastIndexOf(":");if(n<=0||n+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const s=parseInt(e.substring(n+1),10);return e[0]==="["?[e.substring(1,n-1),s]:[e.substring(0,n),s]},yg=()=>Ou()?.config,_g=i=>Ou()?.[`_${i}`];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ir=new ef("@firebase/app"),wE="@firebase/app-compat",TE="@firebase/analytics-compat",IE="@firebase/analytics",SE="@firebase/app-check-compat",AE="@firebase/app-check",CE="@firebase/auth",RE="@firebase/auth-compat",kE="@firebase/database",PE="@firebase/data-connect",NE="@firebase/database-compat",DE="@firebase/functions",xE="@firebase/functions-compat",OE="@firebase/installations",VE="@firebase/installations-compat",LE="@firebase/messaging",ME="@firebase/messaging-compat",UE="@firebase/performance",FE="@firebase/performance-compat",bE="@firebase/remote-config",jE="@firebase/remote-config-compat",zE="@firebase/storage",BE="@firebase/storage-compat",$E="@firebase/firestore",HE="@firebase/ai",WE="@firebase/firestore-compat",qE="firebase",GE="12.2.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lh="[DEFAULT]",KE={[Vh]:"fire-core",[wE]:"fire-core-compat",[IE]:"fire-analytics",[TE]:"fire-analytics-compat",[AE]:"fire-app-check",[SE]:"fire-app-check-compat",[CE]:"fire-auth",[RE]:"fire-auth-compat",[kE]:"fire-rtdb",[PE]:"fire-data-connect",[NE]:"fire-rtdb-compat",[DE]:"fire-fn",[xE]:"fire-fn-compat",[OE]:"fire-iid",[VE]:"fire-iid-compat",[LE]:"fire-fcm",[ME]:"fire-fcm-compat",[UE]:"fire-perf",[FE]:"fire-perf-compat",[bE]:"fire-rc",[jE]:"fire-rc-compat",[zE]:"fire-gcs",[BE]:"fire-gcs-compat",[$E]:"fire-fst",[WE]:"fire-fst-compat",[HE]:"fire-vertex","fire-js":"fire-js",[qE]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Rg,aa,kg,iu,Uh,Pg,Ng,Dg;(function(){var i,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,f,m){return l==Array.prototype||l==Object.prototype||(l[f]=m.value),l};function n(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof Jl=="object"&&Jl];for(var f=0;f<l.length;++f){var m=l[f];if(m&&m.Math==Math)return m}throw Error("Cannot find global object")}var s=n(this);function a(l,f){if(f)e:{var m=s;l=l.split(".");for(var v=0;v<l.length-1;v++){var V=l[v];if(!(V in m))break e;m=m[V]}l=l[l.length-1],v=m[l],f=f(v),f!=v&&f!=null&&e(m,l,{configurable:!0,writable:!0,value:f})}}function c(l,f){l instanceof String&&(l+="");var m=0,v=!1,V={next:function(){if(!v&&m<l.length){var b=m++;return{value:f(b,l[b]),done:!1}}return v=!0,{done:!0,value:void 0}}};return V[Symbol.iterator]=function(){return V},V}a("Array.prototype.values",function(l){return l||function(){return c(this,function(f,m){return m})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var p=p||{},g=this||self;function _(l){var f=typeof l;return f=f!="object"?f:l?Array.isArray(l)?"array":f:"null",f=="array"||f=="object"&&typeof l.length=="number"}function E(l){var f=typeof l;return f=="object"&&l!=null||f=="function"}function C(l,f,m){return l.call.apply(l.bind,arguments)}function D(l,f,m){if(!l)throw Error();if(2<arguments.length){var v=Array.prototype.slice.call(arguments,2);return function(){var V=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(V,v),l.apply(f,V)}}return function(){return l.apply(f,arguments)}}function M(l,f,m){return M=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?C:D,M.apply(null,arguments)}function Q(l,f){var m=Array.prototype.slice.call(arguments,1);return function(){var v=m.slice();return v.push.apply(v,arguments),l.apply(this,v)}}function X(l,f){function m(){}m.prototype=f.prototype,l.aa=f.prototype,l.prototype=new m,l.prototype.constructor=l,l.Qb=function(v,V,b){for(var K=Array(arguments.length-2),Ve=2;Ve<arguments.length;Ve++)K[Ve-2]=arguments[Ve];return f.prototype[V].apply(v,K)}}function Z(l){const f=l.length;if(0<f){const m=Array(f);for(let v=0;v<f;v++)m[v]=l[v];return m}return[]}function J(l,f){for(let m=1;m<arguments.length;m++){const v=arguments[m];if(_(v)){const V=l.length||0,b=v.length||0;l.length=V+b;for(let K=0;K<b;K++)l[V+K]=v[K]}else l.push(v)}}class ye{constructor(f,m){this.i=f,this.j=m,this.h=0,this.g=null}get(){let f;return 0<this.h?(this.h--,f=this.g,this.g=f.next,f.next=null):f=this.i(),f}}function pe(l){return/^[\s\xa0]*$/.test(l)}function me(){var l=g.navigator;return l&&(l=l.userAgent)?l:""}function ke(l){return ke[" "](l),l}ke[" "]=function(){};var tt=me().indexOf("Gecko")!=-1&&!(me().toLowerCase().indexOf("webkit")!=-1&&me().indexOf("Edge")==-1)&&!(me().indexOf("Trident")!=-1||me().indexOf("MSIE")!=-1)&&me().indexOf("Edge")==-1;function Oe(l,f,m){for(const v in l)f.call(m,l[v],v,l)}function P(l,f){for(const m in l)f.call(void 0,l[m],m,l)}function T(l){const f={};for(const m in l)f[m]=l[m];return f}const S="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function k(l,f){let m,v;for(let V=1;V<arguments.length;V++){v=arguments[V];for(m in v)l[m]=v[m];for(let b=0;b<S.length;b++)m=S[b],Object.prototype.hasOwnProperty.call(v,m)&&(l[m]=v[m])}}function N(l){var f=1;l=l.split(":");const m=[];for(;0<f&&l.length;)m.push(l.shift()),f--;return l.length&&m.push(l.join(":")),m}function O(l){g.setTimeout(()=>{throw l},0)}function I(){var l=le;let f=null;return l.g&&(f=l.g,l.g=l.g.next,l.g||(l.h=null),f.next=null),f}class Je{constructor(){this.h=this.g=null}add(f,m){const v=Ct.get();v.set(f,m),this.h?this.h.next=v:this.g=v,this.h=v}}var Ct=new ye(()=>new Rt,l=>l.reset());class Rt{constructor(){this.next=this.g=this.h=null}set(f,m){this.h=f,this.g=m,this.next=null}reset(){this.next=this.g=this.h=null}}let Le,Y=!1,le=new Je,te=()=>{const l=g.Promise.resolve(void 0);Le=()=>{l.then(x)}};var x=()=>{for(var l;l=I();){try{l.h.call(l.g)}catch(m){O(m)}var f=Ct;f.j(l),100>f.h&&(f.h++,l.next=f.g,f.g=l)}Y=!1};function j(){this.s=this.s,this.C=this.C}j.prototype.s=!1,j.prototype.ma=function(){this.s||(this.s=!0,this.N())},j.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ae(l,f){this.type=l,this.g=this.target=f,this.defaultPrevented=!1}ae.prototype.h=function(){this.defaultPrevented=!0};var _e=(function(){if(!g.addEventListener||!Object.defineProperty)return!1;var l=!1,f=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const m=()=>{};g.addEventListener("test",m,f),g.removeEventListener("test",m,f)}catch{}return l})();function Ee(l,f){if(ae.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var m=this.type=l.type,v=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=f,f=l.relatedTarget){if(tt){e:{try{ke(f.nodeName);var V=!0;break e}catch{}V=!1}V||(f=null)}}else m=="mouseover"?f=l.fromElement:m=="mouseout"&&(f=l.toElement);this.relatedTarget=f,v?(this.clientX=v.clientX!==void 0?v.clientX:v.pageX,this.clientY=v.clientY!==void 0?v.clientY:v.pageY,this.screenX=v.screenX||0,this.screenY=v.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:Se[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&Ee.aa.h.call(this)}}X(Ee,ae);var Se={2:"touch",3:"pen",4:"mouse"};Ee.prototype.h=function(){Ee.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var Ne="closure_listenable_"+(1e6*Math.random()|0),De=0;function Ue(l,f,m,v,V){this.listener=l,this.proxy=null,this.src=f,this.type=m,this.capture=!!v,this.ha=V,this.key=++De,this.da=this.fa=!1}function ht(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function Zn(l){this.src=l,this.g={},this.h=0}Zn.prototype.add=function(l,f,m,v,V){var b=l.toString();l=this.g[b],l||(l=this.g[b]=[],this.h++);var K=kr(l,f,v,V);return-1<K?(f=l[K],m||(f.fa=!1)):(f=new Ue(f,this.src,b,!!v,V),f.fa=m,l.push(f)),f};function Zi(l,f){var m=f.type;if(m in l.g){var v=l.g[m],V=Array.prototype.indexOf.call(v,f,void 0),b;(b=0<=V)&&Array.prototype.splice.call(v,V,1),b&&(ht(f),l.g[m].length==0&&(delete l.g[m],l.h--))}}function kr(l,f,m,v){for(var V=0;V<l.length;++V){var b=l[V];if(!b.da&&b.listener==f&&b.capture==!!m&&b.ha==v)return V}return-1}var hi="closure_lm_"+(1e6*Math.random()|0),es={};function co(l,f,m,v,V){if(Array.isArray(f)){for(var b=0;b<f.length;b++)co(l,f[b],m,v,V);return null}return m=po(m),l&&l[Ne]?l.K(f,m,E(v)?!!v.capture:!1,V):ho(l,f,m,!1,v,V)}function ho(l,f,m,v,V,b){if(!f)throw Error("Invalid event type");var K=E(V)?!!V.capture:!!V,Ve=ns(l);if(Ve||(l[hi]=Ve=new Zn(l)),m=Ve.add(f,m,v,K,b),m.proxy)return m;if(v=La(),m.proxy=v,v.src=l,v.listener=m,l.addEventListener)_e||(V=K),V===void 0&&(V=!1),l.addEventListener(f.toString(),v,V);else if(l.attachEvent)l.attachEvent(tr(f.toString()),v);else if(l.addListener&&l.removeListener)l.addListener(v);else throw Error("addEventListener and attachEvent are unavailable.");return m}function La(){function l(m){return f.call(l.src,l.listener,m)}const f=fo;return l}function ts(l,f,m,v,V){if(Array.isArray(f))for(var b=0;b<f.length;b++)ts(l,f[b],m,v,V);else v=E(v)?!!v.capture:!!v,m=po(m),l&&l[Ne]?(l=l.i,f=String(f).toString(),f in l.g&&(b=l.g[f],m=kr(b,m,v,V),-1<m&&(ht(b[m]),Array.prototype.splice.call(b,m,1),b.length==0&&(delete l.g[f],l.h--)))):l&&(l=ns(l))&&(f=l.g[f.toString()],l=-1,f&&(l=kr(f,m,v,V)),(m=-1<l?f[l]:null)&&er(m))}function er(l){if(typeof l!="number"&&l&&!l.da){var f=l.src;if(f&&f[Ne])Zi(f.i,l);else{var m=l.type,v=l.proxy;f.removeEventListener?f.removeEventListener(m,v,l.capture):f.detachEvent?f.detachEvent(tr(m),v):f.addListener&&f.removeListener&&f.removeListener(v),(m=ns(f))?(Zi(m,l),m.h==0&&(m.src=null,f[hi]=null)):ht(l)}}}function tr(l){return l in es?es[l]:es[l]="on"+l}function fo(l,f){if(l.da)l=!0;else{f=new Ee(f,this);var m=l.listener,v=l.ha||l.src;l.fa&&er(l),l=m.call(v,f)}return l}function ns(l){return l=l[hi],l instanceof Zn?l:null}var rs="__closure_events_fn_"+(1e9*Math.random()>>>0);function po(l){return typeof l=="function"?l:(l[rs]||(l[rs]=function(f){return l.handleEvent(f)}),l[rs])}function ot(){j.call(this),this.i=new Zn(this),this.M=this,this.F=null}X(ot,j),ot.prototype[Ne]=!0,ot.prototype.removeEventListener=function(l,f,m,v){ts(this,l,f,m,v)};function at(l,f){var m,v=l.F;if(v)for(m=[];v;v=v.F)m.push(v);if(l=l.M,v=f.type||f,typeof f=="string")f=new ae(f,l);else if(f instanceof ae)f.target=f.target||l;else{var V=f;f=new ae(v,l),k(f,V)}if(V=!0,m)for(var b=m.length-1;0<=b;b--){var K=f.g=m[b];V=nr(K,v,!0,f)&&V}if(K=f.g=l,V=nr(K,v,!0,f)&&V,V=nr(K,v,!1,f)&&V,m)for(b=0;b<m.length;b++)K=f.g=m[b],V=nr(K,v,!1,f)&&V}ot.prototype.N=function(){if(ot.aa.N.call(this),this.i){var l=this.i,f;for(f in l.g){for(var m=l.g[f],v=0;v<m.length;v++)ht(m[v]);delete l.g[f],l.h--}}this.F=null},ot.prototype.K=function(l,f,m,v){return this.i.add(String(l),f,!1,m,v)},ot.prototype.L=function(l,f,m,v){return this.i.add(String(l),f,!0,m,v)};function nr(l,f,m,v){if(f=l.i.g[String(f)],!f)return!0;f=f.concat();for(var V=!0,b=0;b<f.length;++b){var K=f[b];if(K&&!K.da&&K.capture==m){var Ve=K.listener,lt=K.ha||K.src;K.fa&&Zi(l.i,K),V=Ve.call(lt,v)!==!1&&V}}return V&&!v.defaultPrevented}function mo(l,f,m){if(typeof l=="function")m&&(l=M(l,m));else if(l&&typeof l.handleEvent=="function")l=M(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(f)?-1:g.setTimeout(l,f||0)}function Pr(l){l.g=mo(()=>{l.g=null,l.i&&(l.i=!1,Pr(l))},l.l);const f=l.h;l.h=null,l.m.apply(null,f)}class fi extends j{constructor(f,m){super(),this.m=f,this.l=m,this.h=null,this.i=!1,this.g=null}j(f){this.h=arguments,this.g?this.i=!0:Pr(this)}N(){super.N(),this.g&&(g.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function di(l){j.call(this),this.h=l,this.g={}}X(di,j);var go=[];function yo(l){Oe(l.g,function(f,m){this.g.hasOwnProperty(m)&&er(f)},l),l.g={}}di.prototype.N=function(){di.aa.N.call(this),yo(this)},di.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var _o=g.JSON.stringify,vo=g.JSON.parse,Eo=class{stringify(l){return g.JSON.stringify(l,void 0)}parse(l){return g.JSON.parse(l,void 0)}};function pi(){}pi.prototype.h=null;function is(l){return l.h||(l.h=l.i())}function ss(){}var sn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Un(){ae.call(this,"d")}X(Un,ae);function os(){ae.call(this,"c")}X(os,ae);var Fn={},wo=null;function mi(){return wo=wo||new ot}Fn.La="serverreachability";function To(l){ae.call(this,Fn.La,l)}X(To,ae);function rr(l){const f=mi();at(f,new To(f))}Fn.STAT_EVENT="statevent";function Io(l,f){ae.call(this,Fn.STAT_EVENT,l),this.stat=f}X(Io,ae);function Ye(l){const f=mi();at(f,new Io(f,l))}Fn.Ma="timingevent";function as(l,f){ae.call(this,Fn.Ma,l),this.size=f}X(as,ae);function gn(l,f){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return g.setTimeout(function(){l()},f)}function gi(){this.g=!0}gi.prototype.xa=function(){this.g=!1};function yi(l,f,m,v,V,b){l.info(function(){if(l.g)if(b)for(var K="",Ve=b.split("&"),lt=0;lt<Ve.length;lt++){var Ae=Ve[lt].split("=");if(1<Ae.length){var ft=Ae[0];Ae=Ae[1];var nt=ft.split("_");K=2<=nt.length&&nt[1]=="type"?K+(ft+"="+Ae+"&"):K+(ft+"=redacted&")}}else K=null;else K=b;return"XMLHTTP REQ ("+v+") [attempt "+V+"]: "+f+`
`+m+`
`+K})}function ls(l,f,m,v,V,b,K){l.info(function(){return"XMLHTTP RESP ("+v+") [ attempt "+V+"]: "+f+`
`+m+`
`+b+" "+K})}function yn(l,f,m,v){l.info(function(){return"XMLHTTP TEXT ("+f+"): "+Hu(l,m)+(v?" "+v:"")})}function So(l,f){l.info(function(){return"TIMEOUT: "+f})}gi.prototype.info=function(){};function Hu(l,f){if(!l.g)return f;if(!f)return null;try{var m=JSON.parse(f);if(m){for(l=0;l<m.length;l++)if(Array.isArray(m[l])){var v=m[l];if(!(2>v.length)){var V=v[1];if(Array.isArray(V)&&!(1>V.length)){var b=V[0];if(b!="noop"&&b!="stop"&&b!="close")for(var K=1;K<V.length;K++)V[K]=""}}}}return _o(m)}catch{return f}}var us={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Ma={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},_n;function _i(){}X(_i,pi),_i.prototype.g=function(){return new XMLHttpRequest},_i.prototype.i=function(){return{}},_n=new _i;function vn(l,f,m,v){this.j=l,this.i=f,this.l=m,this.R=v||1,this.U=new di(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Ua}function Ua(){this.i=null,this.g="",this.h=!1}var Ao={},cs={};function hs(l,f,m){l.L=1,l.v=Vr(Yt(f)),l.m=m,l.P=!0,Co(l,null)}function Co(l,f){l.F=Date.now(),Fe(l),l.A=Yt(l.v);var m=l.A,v=l.R;Array.isArray(v)||(v=[String(v)]),Mr(m.i,"t",v),l.C=0,m=l.j.J,l.h=new Ua,l.g=tl(l.j,m?f:null,!l.m),0<l.O&&(l.M=new fi(M(l.Y,l,l.g),l.O)),f=l.U,m=l.g,v=l.ca;var V="readystatechange";Array.isArray(V)||(V&&(go[0]=V.toString()),V=go);for(var b=0;b<V.length;b++){var K=co(m,V[b],v||f.handleEvent,!1,f.h||f);if(!K)break;f.g[K.key]=K}f=l.H?T(l.H):{},l.m?(l.u||(l.u="POST"),f["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,f)):(l.u="GET",l.g.ea(l.A,l.u,null,f)),rr(),yi(l.i,l.u,l.A,l.l,l.R,l.m)}vn.prototype.ca=function(l){l=l.target;const f=this.M;f&&Bt(l)==3?f.j():this.Y(l)},vn.prototype.Y=function(l){try{if(l==this.g)e:{const nt=Bt(this.g);var f=this.g.Ba();const ln=this.g.Z();if(!(3>nt)&&(nt!=3||this.g&&(this.h.h||this.g.oa()||xo(this.g)))){this.J||nt!=4||f==7||(f==8||0>=ln?rr(3):rr(2)),vi(this);var m=this.g.Z();this.X=m;t:if(Fa(this)){var v=xo(this.g);l="";var V=v.length,b=Bt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){on(this),Nr(this);var K="";break t}this.h.i=new g.TextDecoder}for(f=0;f<V;f++)this.h.h=!0,l+=this.h.i.decode(v[f],{stream:!(b&&f==V-1)});v.length=0,this.h.g+=l,this.C=0,K=this.h.g}else K=this.g.oa();if(this.o=m==200,ls(this.i,this.u,this.A,this.l,this.R,nt,m),this.o){if(this.T&&!this.K){t:{if(this.g){var Ve,lt=this.g;if((Ve=lt.g?lt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!pe(Ve)){var Ae=Ve;break t}}Ae=null}if(m=Ae)yn(this.i,this.l,m,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Ro(this,m);else{this.o=!1,this.s=3,Ye(12),on(this),Nr(this);break e}}if(this.P){m=!0;let en;for(;!this.J&&this.C<K.length;)if(en=Wu(this,K),en==cs){nt==4&&(this.s=4,Ye(14),m=!1),yn(this.i,this.l,null,"[Incomplete Response]");break}else if(en==Ao){this.s=4,Ye(15),yn(this.i,this.l,K,"[Invalid Chunk]"),m=!1;break}else yn(this.i,this.l,en,null),Ro(this,en);if(Fa(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),nt!=4||K.length!=0||this.h.h||(this.s=1,Ye(16),m=!1),this.o=this.o&&m,!m)yn(this.i,this.l,K,"[Invalid Chunked Response]"),on(this),Nr(this);else if(0<K.length&&!this.W){this.W=!0;var ft=this.j;ft.g==this&&ft.ba&&!ft.M&&(ft.j.info("Great, no buffering proxy detected. Bytes received: "+K.length),Vo(ft),ft.M=!0,Ye(11))}}else yn(this.i,this.l,K,null),Ro(this,K);nt==4&&on(this),this.o&&!this.J&&(nt==4?Ts(this.j,this):(this.o=!1,Fe(this)))}else ys(this.g),m==400&&0<K.indexOf("Unknown SID")?(this.s=3,Ye(12)):(this.s=0,Ye(13)),on(this),Nr(this)}}}catch{}finally{}};function Fa(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function Wu(l,f){var m=l.C,v=f.indexOf(`
`,m);return v==-1?cs:(m=Number(f.substring(m,v)),isNaN(m)?Ao:(v+=1,v+m>f.length?cs:(f=f.slice(v,v+m),l.C=v+m,f)))}vn.prototype.cancel=function(){this.J=!0,on(this)};function Fe(l){l.S=Date.now()+l.I,ba(l,l.I)}function ba(l,f){if(l.B!=null)throw Error("WatchDog timer not null");l.B=gn(M(l.ba,l),f)}function vi(l){l.B&&(g.clearTimeout(l.B),l.B=null)}vn.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(So(this.i,this.A),this.L!=2&&(rr(),Ye(17)),on(this),this.s=2,Nr(this)):ba(this,this.S-l)};function Nr(l){l.j.G==0||l.J||Ts(l.j,l)}function on(l){vi(l);var f=l.M;f&&typeof f.ma=="function"&&f.ma(),l.M=null,yo(l.U),l.g&&(f=l.g,l.g=null,f.abort(),f.ma())}function Ro(l,f){try{var m=l.j;if(m.G!=0&&(m.g==l||Ut(m.h,l))){if(!l.K&&Ut(m.h,l)&&m.G==3){try{var v=m.Da.g.parse(f)}catch{v=null}if(Array.isArray(v)&&v.length==3){var V=v;if(V[0]==0){e:if(!m.u){if(m.g)if(m.g.F+3e3<l.F)ws(m),Sn(m);else break e;Es(m),Ye(18)}}else m.za=V[1],0<m.za-m.T&&37500>V[2]&&m.F&&m.v==0&&!m.C&&(m.C=gn(M(m.Za,m),6e3));if(1>=za(m.h)&&m.ca){try{m.ca()}catch{}m.ca=void 0}}else lr(m,11)}else if((l.K||m.g==l)&&ws(m),!pe(f))for(V=m.Da.g.parse(f),f=0;f<V.length;f++){let Ae=V[f];if(m.T=Ae[0],Ae=Ae[1],m.G==2)if(Ae[0]=="c"){m.K=Ae[1],m.ia=Ae[2];const ft=Ae[3];ft!=null&&(m.la=ft,m.j.info("VER="+m.la));const nt=Ae[4];nt!=null&&(m.Aa=nt,m.j.info("SVER="+m.Aa));const ln=Ae[5];ln!=null&&typeof ln=="number"&&0<ln&&(v=1.5*ln,m.L=v,m.j.info("backChannelRequestTimeoutMs_="+v)),v=m;const en=l.g;if(en){const Ci=en.g?en.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Ci){var b=v.h;b.g||Ci.indexOf("spdy")==-1&&Ci.indexOf("quic")==-1&&Ci.indexOf("h2")==-1||(b.j=b.l,b.g=new Set,b.h&&(ko(b,b.h),b.h=null))}if(v.D){const Ss=en.g?en.g.getResponseHeader("X-HTTP-Session-Id"):null;Ss&&(v.ya=Ss,Me(v.I,v.D,Ss))}}m.G=3,m.l&&m.l.ua(),m.ba&&(m.R=Date.now()-l.F,m.j.info("Handshake RTT: "+m.R+"ms")),v=m;var K=l;if(v.qa=el(v,v.J?v.ia:null,v.W),K.K){Ba(v.h,K);var Ve=K,lt=v.L;lt&&(Ve.I=lt),Ve.B&&(vi(Ve),Fe(Ve)),v.g=K}else Ai(v);0<m.i.length&&Bn(m)}else Ae[0]!="stop"&&Ae[0]!="close"||lr(m,7);else m.G==3&&(Ae[0]=="stop"||Ae[0]=="close"?Ae[0]=="stop"?lr(m,7):vt(m):Ae[0]!="noop"&&m.l&&m.l.ta(Ae),m.v=0)}}rr(4)}catch{}}var ja=class{constructor(l,f){this.g=l,this.map=f}};function Ei(l){this.l=l||10,g.PerformanceNavigationTiming?(l=g.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(g.chrome&&g.chrome.loadTimes&&g.chrome.loadTimes()&&g.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Jt(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function za(l){return l.h?1:l.g?l.g.size:0}function Ut(l,f){return l.h?l.h==f:l.g?l.g.has(f):!1}function ko(l,f){l.g?l.g.add(f):l.h=f}function Ba(l,f){l.h&&l.h==f?l.h=null:l.g&&l.g.has(f)&&l.g.delete(f)}Ei.prototype.cancel=function(){if(this.i=$a(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function $a(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let f=l.i;for(const m of l.g.values())f=f.concat(m.D);return f}return Z(l.i)}function fs(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(_(l)){for(var f=[],m=l.length,v=0;v<m;v++)f.push(l[v]);return f}f=[],m=0;for(v in l)f[m++]=l[v];return f}function ds(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(_(l)||typeof l=="string"){var f=[];l=l.length;for(var m=0;m<l;m++)f.push(m);return f}f=[],m=0;for(const v in l)f[m++]=v;return f}}}function Dr(l,f){if(l.forEach&&typeof l.forEach=="function")l.forEach(f,void 0);else if(_(l)||typeof l=="string")Array.prototype.forEach.call(l,f,void 0);else for(var m=ds(l),v=fs(l),V=v.length,b=0;b<V;b++)f.call(void 0,v[b],m&&m[b],l)}var wi=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function qu(l,f){if(l){l=l.split("&");for(var m=0;m<l.length;m++){var v=l[m].indexOf("="),V=null;if(0<=v){var b=l[m].substring(0,v);V=l[m].substring(v+1)}else b=l[m];f(b,V?decodeURIComponent(V.replace(/\+/g," ")):"")}}}function ir(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof ir){this.h=l.h,Ti(this,l.j),this.o=l.o,this.g=l.g,xr(this,l.s),this.l=l.l;var f=l.i,m=new bn;m.i=f.i,f.g&&(m.g=new Map(f.g),m.h=f.h),Or(this,m),this.m=l.m}else l&&(f=String(l).match(wi))?(this.h=!1,Ti(this,f[1]||"",!0),this.o=Ie(f[2]||""),this.g=Ie(f[3]||"",!0),xr(this,f[4]),this.l=Ie(f[5]||"",!0),Or(this,f[6]||"",!0),this.m=Ie(f[7]||"")):(this.h=!1,this.i=new bn(null,this.h))}ir.prototype.toString=function(){var l=[],f=this.j;f&&l.push(Lr(f,ps,!0),":");var m=this.g;return(m||f=="file")&&(l.push("//"),(f=this.o)&&l.push(Lr(f,ps,!0),"@"),l.push(encodeURIComponent(String(m)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),m=this.s,m!=null&&l.push(":",String(m))),(m=this.l)&&(this.g&&m.charAt(0)!="/"&&l.push("/"),l.push(Lr(m,m.charAt(0)=="/"?qa:Wa,!0))),(m=this.i.toString())&&l.push("?",m),(m=this.m)&&l.push("#",Lr(m,Po)),l.join("")};function Yt(l){return new ir(l)}function Ti(l,f,m){l.j=m?Ie(f,!0):f,l.j&&(l.j=l.j.replace(/:$/,""))}function xr(l,f){if(f){if(f=Number(f),isNaN(f)||0>f)throw Error("Bad port number "+f);l.s=f}else l.s=null}function Or(l,f,m){f instanceof bn?(l.i=f,jn(l.i,l.h)):(m||(f=Lr(f,Ga)),l.i=new bn(f,l.h))}function Me(l,f,m){l.i.set(f,m)}function Vr(l){return Me(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function Ie(l,f){return l?f?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Lr(l,f,m){return typeof l=="string"?(l=encodeURI(l).replace(f,Ha),m&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function Ha(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var ps=/[#\/\?@]/g,Wa=/[#\?:]/g,qa=/[#\?]/g,Ga=/[#\?@]/g,Po=/#/g;function bn(l,f){this.h=this.g=null,this.i=l||null,this.j=!!f}function _t(l){l.g||(l.g=new Map,l.h=0,l.i&&qu(l.i,function(f,m){l.add(decodeURIComponent(f.replace(/\+/g," ")),m)}))}i=bn.prototype,i.add=function(l,f){_t(this),this.i=null,l=an(this,l);var m=this.g.get(l);return m||this.g.set(l,m=[]),m.push(f),this.h+=1,this};function En(l,f){_t(l),f=an(l,f),l.g.has(f)&&(l.i=null,l.h-=l.g.get(f).length,l.g.delete(f))}function wn(l,f){return _t(l),f=an(l,f),l.g.has(f)}i.forEach=function(l,f){_t(this),this.g.forEach(function(m,v){m.forEach(function(V){l.call(f,V,v,this)},this)},this)},i.na=function(){_t(this);const l=Array.from(this.g.values()),f=Array.from(this.g.keys()),m=[];for(let v=0;v<f.length;v++){const V=l[v];for(let b=0;b<V.length;b++)m.push(f[v])}return m},i.V=function(l){_t(this);let f=[];if(typeof l=="string")wn(this,l)&&(f=f.concat(this.g.get(an(this,l))));else{l=Array.from(this.g.values());for(let m=0;m<l.length;m++)f=f.concat(l[m])}return f},i.set=function(l,f){return _t(this),this.i=null,l=an(this,l),wn(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[f]),this.h+=1,this},i.get=function(l,f){return l?(l=this.V(l),0<l.length?String(l[0]):f):f};function Mr(l,f,m){En(l,f),0<m.length&&(l.i=null,l.g.set(an(l,f),Z(m)),l.h+=m.length)}i.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],f=Array.from(this.g.keys());for(var m=0;m<f.length;m++){var v=f[m];const b=encodeURIComponent(String(v)),K=this.V(v);for(v=0;v<K.length;v++){var V=b;K[v]!==""&&(V+="="+encodeURIComponent(String(K[v]))),l.push(V)}}return this.i=l.join("&")};function an(l,f){return f=String(f),l.j&&(f=f.toLowerCase()),f}function jn(l,f){f&&!l.j&&(_t(l),l.i=null,l.g.forEach(function(m,v){var V=v.toLowerCase();v!=V&&(En(this,v),Mr(this,V,m))},l)),l.j=f}function Gu(l,f){const m=new gi;if(g.Image){const v=new Image;v.onload=Q(zt,m,"TestLoadImage: loaded",!0,f,v),v.onerror=Q(zt,m,"TestLoadImage: error",!1,f,v),v.onabort=Q(zt,m,"TestLoadImage: abort",!1,f,v),v.ontimeout=Q(zt,m,"TestLoadImage: timeout",!1,f,v),g.setTimeout(function(){v.ontimeout&&v.ontimeout()},1e4),v.src=l}else f(!1)}function Ka(l,f){const m=new gi,v=new AbortController,V=setTimeout(()=>{v.abort(),zt(m,"TestPingServer: timeout",!1,f)},1e4);fetch(l,{signal:v.signal}).then(b=>{clearTimeout(V),b.ok?zt(m,"TestPingServer: ok",!0,f):zt(m,"TestPingServer: server error",!1,f)}).catch(()=>{clearTimeout(V),zt(m,"TestPingServer: error",!1,f)})}function zt(l,f,m,v,V){try{V&&(V.onload=null,V.onerror=null,V.onabort=null,V.ontimeout=null),v(m)}catch{}}function Ku(){this.g=new Eo}function Qa(l,f,m){const v=m||"";try{Dr(l,function(V,b){let K=V;E(V)&&(K=_o(V)),f.push(v+b+"="+encodeURIComponent(K))})}catch(V){throw f.push(v+"type="+encodeURIComponent("_badmap")),V}}function sr(l){this.l=l.Ub||null,this.j=l.eb||!1}X(sr,pi),sr.prototype.g=function(){return new Ii(this.l,this.j)},sr.prototype.i=(function(l){return function(){return l}})({});function Ii(l,f){ot.call(this),this.D=l,this.o=f,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}X(Ii,ot),i=Ii.prototype,i.open=function(l,f){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=f,this.readyState=1,In(this)},i.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const f={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(f.body=l),(this.D||g).fetch(new Request(this.A,f)).then(this.Sa.bind(this),this.ga.bind(this))},i.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Tn(this)),this.readyState=0},i.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,In(this)),this.g&&(this.readyState=3,In(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof g.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Xa(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function Xa(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}i.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var f=l.value?l.value:new Uint8Array(0);(f=this.v.decode(f,{stream:!l.done}))&&(this.response=this.responseText+=f)}l.done?Tn(this):In(this),this.readyState==3&&Xa(this)}},i.Ra=function(l){this.g&&(this.response=this.responseText=l,Tn(this))},i.Qa=function(l){this.g&&(this.response=l,Tn(this))},i.ga=function(){this.g&&Tn(this)};function Tn(l){l.readyState=4,l.l=null,l.j=null,l.v=null,In(l)}i.setRequestHeader=function(l,f){this.u.append(l,f)},i.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},i.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],f=this.h.entries();for(var m=f.next();!m.done;)m=m.value,l.push(m[0]+": "+m[1]),m=f.next();return l.join(`\r
`)};function In(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(Ii.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function or(l){let f="";return Oe(l,function(m,v){f+=v,f+=":",f+=m,f+=`\r
`}),f}function Ur(l,f,m){e:{for(v in m){var v=!1;break e}v=!0}v||(m=or(m),typeof l=="string"?m!=null&&encodeURIComponent(String(m)):Me(l,f,m))}function $e(l){ot.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}X($e,ot);var Qu=/^https?$/i,No=["POST","PUT"];i=$e.prototype,i.Ha=function(l){this.J=l},i.ea=function(l,f,m,v){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);f=f?f.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():_n.g(),this.v=this.o?is(this.o):is(_n),this.g.onreadystatechange=M(this.Ea,this);try{this.B=!0,this.g.open(f,String(l),!0),this.B=!1}catch(b){Si(this,b);return}if(l=m||"",m=new Map(this.headers),v)if(Object.getPrototypeOf(v)===Object.prototype)for(var V in v)m.set(V,v[V]);else if(typeof v.keys=="function"&&typeof v.get=="function")for(const b of v.keys())m.set(b,v.get(b));else throw Error("Unknown input type for opt_headers: "+String(v));v=Array.from(m.keys()).find(b=>b.toLowerCase()=="content-type"),V=g.FormData&&l instanceof g.FormData,!(0<=Array.prototype.indexOf.call(No,f,void 0))||v||V||m.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[b,K]of m)this.g.setRequestHeader(b,K);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{gs(this),this.u=!0,this.g.send(l),this.u=!1}catch(b){Si(this,b)}};function Si(l,f){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=f,l.m=5,ms(l),Zt(l)}function ms(l){l.A||(l.A=!0,at(l,"complete"),at(l,"error"))}i.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,at(this,"complete"),at(this,"abort"),Zt(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Zt(this,!0)),$e.aa.N.call(this)},i.Ea=function(){this.s||(this.B||this.u||this.j?Do(this):this.bb())},i.bb=function(){Do(this)};function Do(l){if(l.h&&typeof p<"u"&&(!l.v[1]||Bt(l)!=4||l.Z()!=2)){if(l.u&&Bt(l)==4)mo(l.Ea,0,l);else if(at(l,"readystatechange"),Bt(l)==4){l.h=!1;try{const K=l.Z();e:switch(K){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var f=!0;break e;default:f=!1}var m;if(!(m=f)){var v;if(v=K===0){var V=String(l.D).match(wi)[1]||null;!V&&g.self&&g.self.location&&(V=g.self.location.protocol.slice(0,-1)),v=!Qu.test(V?V.toLowerCase():"")}m=v}if(m)at(l,"complete"),at(l,"success");else{l.m=6;try{var b=2<Bt(l)?l.g.statusText:""}catch{b=""}l.l=b+" ["+l.Z()+"]",ms(l)}}finally{Zt(l)}}}}function Zt(l,f){if(l.g){gs(l);const m=l.g,v=l.v[0]?()=>{}:null;l.g=null,l.v=null,f||at(l,"ready");try{m.onreadystatechange=v}catch{}}}function gs(l){l.I&&(g.clearTimeout(l.I),l.I=null)}i.isActive=function(){return!!this.g};function Bt(l){return l.g?l.g.readyState:0}i.Z=function(){try{return 2<Bt(this)?this.g.status:-1}catch{return-1}},i.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.Oa=function(l){if(this.g){var f=this.g.responseText;return l&&f.indexOf(l)==0&&(f=f.substring(l.length)),vo(f)}};function xo(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function ys(l){const f={};l=(l.g&&2<=Bt(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let v=0;v<l.length;v++){if(pe(l[v]))continue;var m=N(l[v]);const V=m[0];if(m=m[1],typeof m!="string")continue;m=m.trim();const b=f[V]||[];f[V]=b,b.push(m)}P(f,function(v){return v.join(", ")})}i.Ba=function(){return this.m},i.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function zn(l,f,m){return m&&m.internalChannelParams&&m.internalChannelParams[l]||f}function Oo(l){this.Aa=0,this.i=[],this.j=new gi,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=zn("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=zn("baseRetryDelayMs",5e3,l),this.cb=zn("retryDelaySeedMs",1e4,l),this.Wa=zn("forwardChannelMaxRetries",2,l),this.wa=zn("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new Ei(l&&l.concurrentRequestLimit),this.Da=new Ku,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}i=Oo.prototype,i.la=8,i.G=1,i.connect=function(l,f,m,v){Ye(0),this.W=l,this.H=f||{},m&&v!==void 0&&(this.H.OSID=m,this.H.OAID=v),this.F=this.X,this.I=el(this,null,this.W),Bn(this)};function vt(l){if(_s(l),l.G==3){var f=l.U++,m=Yt(l.I);if(Me(m,"SID",l.K),Me(m,"RID",f),Me(m,"TYPE","terminate"),ar(l,m),f=new vn(l,l.j,f),f.L=2,f.v=Vr(Yt(m)),m=!1,g.navigator&&g.navigator.sendBeacon)try{m=g.navigator.sendBeacon(f.v.toString(),"")}catch{}!m&&g.Image&&(new Image().src=f.v,m=!0),m||(f.g=tl(f.j,null),f.g.ea(f.v)),f.F=Date.now(),Fe(f)}Za(l)}function Sn(l){l.g&&(Vo(l),l.g.cancel(),l.g=null)}function _s(l){Sn(l),l.u&&(g.clearTimeout(l.u),l.u=null),ws(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&g.clearTimeout(l.s),l.s=null)}function Bn(l){if(!Jt(l.h)&&!l.s){l.s=!0;var f=l.Ga;Le||te(),Y||(Le(),Y=!0),le.add(f,l),l.B=0}}function Xu(l,f){return za(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=f.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=gn(M(l.Ga,l,f),Ya(l,l.B)),l.B++,!0)}i.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const V=new vn(this,this.j,l);let b=this.o;if(this.S&&(b?(b=T(b),k(b,this.S)):b=this.S),this.m!==null||this.O||(V.H=b,b=null),this.P)e:{for(var f=0,m=0;m<this.i.length;m++){t:{var v=this.i[m];if("__data__"in v.map&&(v=v.map.__data__,typeof v=="string")){v=v.length;break t}v=void 0}if(v===void 0)break;if(f+=v,4096<f){f=m;break e}if(f===4096||m===this.i.length-1){f=m+1;break e}}f=1e3}else f=1e3;f=Fr(this,V,f),m=Yt(this.I),Me(m,"RID",l),Me(m,"CVER",22),this.D&&Me(m,"X-HTTP-Session-Id",this.D),ar(this,m),b&&(this.O?f="headers="+encodeURIComponent(String(or(b)))+"&"+f:this.m&&Ur(m,this.m,b)),ko(this.h,V),this.Ua&&Me(m,"TYPE","init"),this.P?(Me(m,"$req",f),Me(m,"SID","null"),V.T=!0,hs(V,m,null)):hs(V,m,f),this.G=2}}else this.G==3&&(l?vs(this,l):this.i.length==0||Jt(this.h)||vs(this))};function vs(l,f){var m;f?m=f.l:m=l.U++;const v=Yt(l.I);Me(v,"SID",l.K),Me(v,"RID",m),Me(v,"AID",l.T),ar(l,v),l.m&&l.o&&Ur(v,l.m,l.o),m=new vn(l,l.j,m,l.B+1),l.m===null&&(m.H=l.o),f&&(l.i=f.D.concat(l.i)),f=Fr(l,m,1e3),m.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),ko(l.h,m),hs(m,v,f)}function ar(l,f){l.H&&Oe(l.H,function(m,v){Me(f,v,m)}),l.l&&Dr({},function(m,v){Me(f,v,m)})}function Fr(l,f,m){m=Math.min(l.i.length,m);var v=l.l?M(l.l.Na,l.l,l):null;e:{var V=l.i;let b=-1;for(;;){const K=["count="+m];b==-1?0<m?(b=V[0].g,K.push("ofs="+b)):b=0:K.push("ofs="+b);let Ve=!0;for(let lt=0;lt<m;lt++){let Ae=V[lt].g;const ft=V[lt].map;if(Ae-=b,0>Ae)b=Math.max(0,V[lt].g-100),Ve=!1;else try{Qa(ft,K,"req"+Ae+"_")}catch{v&&v(ft)}}if(Ve){v=K.join("&");break e}}}return l=l.i.splice(0,m),f.D=l,v}function Ai(l){if(!l.g&&!l.u){l.Y=1;var f=l.Fa;Le||te(),Y||(Le(),Y=!0),le.add(f,l),l.v=0}}function Es(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=gn(M(l.Fa,l),Ya(l,l.v)),l.v++,!0)}i.Fa=function(){if(this.u=null,Ja(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=gn(M(this.ab,this),l)}},i.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Ye(10),Sn(this),Ja(this))};function Vo(l){l.A!=null&&(g.clearTimeout(l.A),l.A=null)}function Ja(l){l.g=new vn(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var f=Yt(l.qa);Me(f,"RID","rpc"),Me(f,"SID",l.K),Me(f,"AID",l.T),Me(f,"CI",l.F?"0":"1"),!l.F&&l.ja&&Me(f,"TO",l.ja),Me(f,"TYPE","xmlhttp"),ar(l,f),l.m&&l.o&&Ur(f,l.m,l.o),l.L&&(l.g.I=l.L);var m=l.g;l=l.ia,m.L=1,m.v=Vr(Yt(f)),m.m=null,m.P=!0,Co(m,l)}i.Za=function(){this.C!=null&&(this.C=null,Sn(this),Es(this),Ye(19))};function ws(l){l.C!=null&&(g.clearTimeout(l.C),l.C=null)}function Ts(l,f){var m=null;if(l.g==f){ws(l),Vo(l),l.g=null;var v=2}else if(Ut(l.h,f))m=f.D,Ba(l.h,f),v=1;else return;if(l.G!=0){if(f.o)if(v==1){m=f.m?f.m.length:0,f=Date.now()-f.F;var V=l.B;v=mi(),at(v,new as(v,m)),Bn(l)}else Ai(l);else if(V=f.s,V==3||V==0&&0<f.X||!(v==1&&Xu(l,f)||v==2&&Es(l)))switch(m&&0<m.length&&(f=l.h,f.i=f.i.concat(m)),V){case 1:lr(l,5);break;case 4:lr(l,10);break;case 3:lr(l,6);break;default:lr(l,2)}}}function Ya(l,f){let m=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(m*=2),m*f}function lr(l,f){if(l.j.info("Error code "+f),f==2){var m=M(l.fb,l),v=l.Xa;const V=!v;v=new ir(v||"//www.google.com/images/cleardot.gif"),g.location&&g.location.protocol=="http"||Ti(v,"https"),Vr(v),V?Gu(v.toString(),m):Ka(v.toString(),m)}else Ye(2);l.G=0,l.l&&l.l.sa(f),Za(l),_s(l)}i.fb=function(l){l?(this.j.info("Successfully pinged google.com"),Ye(2)):(this.j.info("Failed to ping google.com"),Ye(1))};function Za(l){if(l.G=0,l.ka=[],l.l){const f=$a(l.h);(f.length!=0||l.i.length!=0)&&(J(l.ka,f),J(l.ka,l.i),l.h.i.length=0,Z(l.i),l.i.length=0),l.l.ra()}}function el(l,f,m){var v=m instanceof ir?Yt(m):new ir(m);if(v.g!="")f&&(v.g=f+"."+v.g),xr(v,v.s);else{var V=g.location;v=V.protocol,f=f?f+"."+V.hostname:V.hostname,V=+V.port;var b=new ir(null);v&&Ti(b,v),f&&(b.g=f),V&&xr(b,V),m&&(b.l=m),v=b}return m=l.D,f=l.ya,m&&f&&Me(v,m,f),Me(v,"VER",l.la),ar(l,v),v}function tl(l,f,m){if(f&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return f=l.Ca&&!l.pa?new $e(new sr({eb:m})):new $e(l.pa),f.Ha(l.J),f}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function Lo(){}i=Lo.prototype,i.ua=function(){},i.ta=function(){},i.sa=function(){},i.ra=function(){},i.isActive=function(){return!0},i.Na=function(){};function Is(){}Is.prototype.g=function(l,f){return new Ft(l,f)};function Ft(l,f){ot.call(this),this.g=new Oo(f),this.l=l,this.h=f&&f.messageUrlParams||null,l=f&&f.messageHeaders||null,f&&f.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=f&&f.initMessageHeaders||null,f&&f.messageContentType&&(l?l["X-WebChannel-Content-Type"]=f.messageContentType:l={"X-WebChannel-Content-Type":f.messageContentType}),f&&f.va&&(l?l["X-WebChannel-Client-Profile"]=f.va:l={"X-WebChannel-Client-Profile":f.va}),this.g.S=l,(l=f&&f.Sb)&&!pe(l)&&(this.g.m=l),this.v=f&&f.supportsCrossDomainXhr||!1,this.u=f&&f.sendRawJson||!1,(f=f&&f.httpSessionIdParam)&&!pe(f)&&(this.g.D=f,l=this.h,l!==null&&f in l&&(l=this.h,f in l&&delete l[f])),this.j=new $n(this)}X(Ft,ot),Ft.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Ft.prototype.close=function(){vt(this.g)},Ft.prototype.o=function(l){var f=this.g;if(typeof l=="string"){var m={};m.__data__=l,l=m}else this.u&&(m={},m.__data__=_o(l),l=m);f.i.push(new ja(f.Ya++,l)),f.G==3&&Bn(f)},Ft.prototype.N=function(){this.g.l=null,delete this.j,vt(this.g),delete this.g,Ft.aa.N.call(this)};function nl(l){Un.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var f=l.__sm__;if(f){e:{for(const m in f){l=m;break e}l=void 0}(this.i=l)&&(l=this.i,f=f!==null&&l in f?f[l]:void 0),this.data=f}else this.data=l}X(nl,Un);function rl(){os.call(this),this.status=1}X(rl,os);function $n(l){this.g=l}X($n,Lo),$n.prototype.ua=function(){at(this.g,"a")},$n.prototype.ta=function(l){at(this.g,new nl(l))},$n.prototype.sa=function(l){at(this.g,new rl)},$n.prototype.ra=function(){at(this.g,"b")},Is.prototype.createWebChannel=Is.prototype.g,Ft.prototype.send=Ft.prototype.o,Ft.prototype.open=Ft.prototype.m,Ft.prototype.close=Ft.prototype.close,Dg=function(){return new Is},Ng=function(){return mi()},Pg=Fn,Uh={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},us.NO_ERROR=0,us.TIMEOUT=8,us.HTTP_ERROR=6,iu=us,Ma.COMPLETE="complete",kg=Ma,ss.EventType=sn,sn.OPEN="a",sn.CLOSE="b",sn.ERROR="c",sn.MESSAGE="d",ot.prototype.listen=ot.prototype.K,aa=ss,$e.prototype.listenOnce=$e.prototype.L,$e.prototype.getLastError=$e.prototype.Ka,$e.prototype.getLastErrorCode=$e.prototype.Ba,$e.prototype.getStatus=$e.prototype.Z,$e.prototype.getResponseJson=$e.prototype.Oa,$e.prototype.getResponseText=$e.prototype.oa,$e.prototype.send=$e.prototype.ea,$e.prototype.setWithCredentials=$e.prototype.Ha,Rg=$e}).apply(typeof Jl<"u"?Jl:typeof self<"u"?self:typeof window<"u"?window:{});const um="@firebase/firestore",cm="4.9.1";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qi=new ef("@firebase/firestore");function Ws(){return qi.logLevel}function se(i,...e){if(qi.logLevel<=Te.DEBUG){const n=e.map(sf);qi.debug(`Firestore (${ao}): ${i}`,...n)}}function Gi(i,...e){if(qi.logLevel<=Te.ERROR){const n=e.map(sf);qi.error(`Firestore (${ao}): ${i}`,...n)}}function Vu(i,...e){if(qi.logLevel<=Te.WARN){const n=e.map(sf);qi.warn(`Firestore (${ao}): ${i}`,...n)}}function sf(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ve(i,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,xg(i,s,n)}function xg(i,e,n){let s=`FIRESTORE (${ao}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw Gi(s),new Error(s)}function Xe(i,e,n,s){let a="Unexpected state";typeof n=="string"?a=n:s=n,i||xg(e,a,s)}function je(i,e){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Og{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class cw{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable((()=>n(Ot.UNAUTHENTICATED)))}shutdown(){}}class hw{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable((()=>n(this.token.user)))}shutdown(){this.changeListener=null}}class fw{constructor(e){this.t=e,this.currentUser=Ot.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){Xe(this.o===void 0,42304);let s=this.i;const a=_=>this.i!==s?(s=this.i,n(_)):Promise.resolve();let c=new Bi;this.o=()=>{this.i++,this.currentUser=this.u(),c.resolve(),c=new Bi,e.enqueueRetryable((()=>a(this.currentUser)))};const p=()=>{const _=c;e.enqueueRetryable((async()=>{await _.promise,await a(this.currentUser)}))},g=_=>{se("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=_,this.o&&(this.auth.addAuthTokenListener(this.o),p())};this.t.onInit((_=>g(_))),setTimeout((()=>{if(!this.auth){const _=this.t.getImmediate({optional:!0});_?g(_):(se("FirebaseAuthCredentialsProvider","Auth not yet detected"),c.resolve(),c=new Bi)}}),0),p()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then((s=>this.i!==e?(se("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):s?(Xe(typeof s.accessToken=="string",31837,{l:s}),new Og(s.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Xe(e===null||typeof e=="string",2055,{h:e}),new Ot(e)}}class dw{constructor(e,n,s){this.P=e,this.T=n,this.I=s,this.type="FirstParty",this.user=Ot.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const e=this.R();return e&&this.A.set("Authorization",e),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class pw{constructor(e,n,s){this.P=e,this.T=n,this.I=s}getToken(){return Promise.resolve(new dw(this.P,this.T,this.I))}start(e,n){e.enqueueRetryable((()=>n(Ot.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class hm{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class mw{constructor(e,n){this.V=n,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,mn(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,n){Xe(this.o===void 0,3512);const s=c=>{c.error!=null&&se("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${c.error.message}`);const p=c.token!==this.m;return this.m=c.token,se("FirebaseAppCheckTokenProvider",`Received ${p?"new":"existing"} token.`),p?n(c.token):Promise.resolve()};this.o=c=>{e.enqueueRetryable((()=>s(c)))};const a=c=>{se("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=c,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((c=>a(c))),setTimeout((()=>{if(!this.appCheck){const c=this.V.getImmediate({optional:!0});c?a(c):se("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new hm(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((n=>n?(Xe(typeof n.token=="string",44558,{tokenResult:n}),this.m=n.token,new hm(n.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lf(i){if(i.code!==W.FAILED_PRECONDITION||i.message!==Aw)throw i;se("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn{constructor(e){this.binaryString=e}static fromBase64String(e){const n=(function(a){try{return atob(a)}catch(c){throw typeof DOMException<"u"&&c instanceof DOMException?new Dw("Invalid base64 string: "+c):c}})(e);return new Jn(n)}static fromUint8Array(e){const n=(function(a){let c="";for(let p=0;p<a.length;++p)c+=String.fromCharCode(a[p]);return c})(e);return new Jn(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(n){return btoa(n)})(this.binaryString)}toUint8Array(){return(function(n){const s=new Uint8Array(n.length);for(let a=0;a<n.length;a++)s[a]=n.charCodeAt(a);return s})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return xe(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Jn.EMPTY_BYTE_STRING=new Jn("");const xw=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Ki(i){if(Xe(!!i,39018),typeof i=="string"){let e=0;const n=xw.exec(i);if(Xe(!!n,46558,{timestamp:i}),n[1]){let a=n[1];a=(a+"000000000").substr(0,9),e=Number(a)}const s=new Date(i);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:It(i.seconds),nanos:It(i.nanos)}}function It(i){return typeof i=="number"?i:typeof i=="string"?Number(i):0}function to(i){return typeof i=="string"?Jn.fromBase64String(i):Jn.fromUint8Array(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q0{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return Hv()?8:Rw(Mt())>0?6:4})()}initialize(e,n){this.ps=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,s,a){const c={result:null};return this.ys(e,n).next((p=>{c.result=p})).next((()=>{if(!c.result)return this.ws(e,n,a,s).next((p=>{c.result=p}))})).next((()=>{if(c.result)return;const p=new K0;return this.Ss(e,n,p).next((g=>{if(c.result=g,this.Vs)return this.bs(e,n,p,g.size)}))})).next((()=>c.result))}bs(e,n,s,a){return s.documentReadCount<this.fs?(Ws()<=Te.DEBUG&&se("QueryEngine","SDK will not create cache indexes for query:",oa(n),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),z.resolve()):(Ws()<=Te.DEBUG&&se("QueryEngine","Query:",oa(n),"scans",s.documentReadCount,"local documents and returns",a,"documents as results."),s.documentReadCount>this.gs*a?(Ws()<=Te.DEBUG&&se("QueryEngine","The SDK decides to create cache indexes for query:",oa(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,$i(n))):z.resolve())}ys(e,n){if(Sm(n))return z.resolve(null);let s=$i(n);return this.indexManager.getIndexType(e,s).next((a=>a===0?null:(n.limit!==null&&a===1&&(n=Hh(n,null,"F"),s=$i(n)),this.indexManager.getDocumentsMatchingTarget(e,s).next((c=>{const p=Vt(...c);return this.ps.getDocuments(e,p).next((g=>this.indexManager.getMinOffset(e,s).next((_=>{const E=this.Ds(n,g);return this.Cs(n,E,p,_.readTime)?this.ys(e,Hh(n,null,"F")):this.vs(e,E,n,_)}))))})))))}ws(e,n,s,a){return Sm(n)||a.isEqual(We.min())?z.resolve(null):this.ps.getDocuments(e,s).next((c=>{const p=this.Ds(n,c);return this.Cs(n,p,s,a)?z.resolve(null):(Ws()<=Te.DEBUG&&se("QueryEngine","Re-using previous result from %s to execute query: %s",a.toString(),oa(n)),this.vs(e,p,n,Tw(a,ga)).next((g=>g)))}))}Ds(e,n){let s=new At(Jw(e));return n.forEach(((a,c)=>{yf(e,c)&&(s=s.add(c))})),s}Cs(e,n,s,a){if(e.limit===null)return!1;if(s.size!==n.size)return!0;const c=e.limitType==="F"?n.last():n.first();return!!c&&(c.hasPendingWrites||c.version.compareTo(a)>0)}Ss(e,n,s){return Ws()<=Te.DEBUG&&se("QueryEngine","Using full collection scan to execute query:",oa(n)),this.ps.getDocumentsMatchingQuery(e,n,ai.min(),s)}vs(e,n,s,a){return this.ps.getDocumentsMatchingQuery(e,s,a).next((c=>(n.forEach((p=>{c=c.insert(p.key,p)})),c)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vm="ConnectivityMonitor";class Lm{constructor(){this.No=()=>this.Bo(),this.Lo=()=>this.ko(),this.qo=[],this.Qo()}Oo(e){this.qo.push(e)}shutdown(){window.removeEventListener("online",this.No),window.removeEventListener("offline",this.Lo)}Qo(){window.addEventListener("online",this.No),window.addEventListener("offline",this.Lo)}Bo(){se(Vm,"Network connectivity changed: AVAILABLE");for(const e of this.qo)e(0)}ko(){se(Vm,"Network connectivity changed: UNAVAILABLE");for(const e of this.qo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xt="WebChannelConnection";class aT extends sT{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,s,a,c){const p=Kh();return new Promise(((g,_)=>{const E=new Rg;E.setWithCredentials(!0),E.listenOnce(kg.COMPLETE,(()=>{try{switch(E.getLastErrorCode()){case iu.NO_ERROR:const D=E.getResponseJson();se(xt,`XHR for RPC '${e}' ${p} received:`,JSON.stringify(D)),g(D);break;case iu.TIMEOUT:se(xt,`RPC '${e}' ${p} timed out`),_(new he(W.DEADLINE_EXCEEDED,"Request time out"));break;case iu.HTTP_ERROR:const M=E.getStatus();if(se(xt,`RPC '${e}' ${p} failed with status:`,M,"response text:",E.getResponseText()),M>0){let Q=E.getResponseJson();Array.isArray(Q)&&(Q=Q[0]);const X=Q?.error;if(X&&X.status&&X.message){const Z=(function(ye){const pe=ye.toLowerCase().replace(/_/g,"-");return Object.values(W).indexOf(pe)>=0?pe:W.UNKNOWN})(X.status);_(new he(Z,X.message))}else _(new he(W.UNKNOWN,"Server responded with status "+E.getStatus()))}else _(new he(W.UNAVAILABLE,"Connection failed."));break;default:ve(9055,{l_:e,streamId:p,h_:E.getLastErrorCode(),P_:E.getLastError()})}}finally{se(xt,`RPC '${e}' ${p} completed.`)}}));const C=JSON.stringify(a);se(xt,`RPC '${e}' ${p} sending request:`,a),E.send(n,"POST",C,s,15)}))}T_(e,n,s){const a=Kh(),c=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],p=Dg(),g=Ng(),_={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},E=this.longPollingOptions.timeoutSeconds;E!==void 0&&(_.longPollingTimeout=Math.round(1e3*E)),this.useFetchStreams&&(_.useFetchStreams=!0),this.jo(_.initMessageHeaders,n,s),_.encodeInitMessageHeaders=!0;const C=c.join("");se(xt,`Creating RPC '${e}' stream ${a}: ${C}`,_);const D=p.createWebChannel(C,_);this.I_(D);let M=!1,Q=!1;const X=new oT({Yo:J=>{Q?se(xt,`Not sending because RPC '${e}' stream ${a} is closed:`,J):(M||(se(xt,`Opening RPC '${e}' stream ${a} transport.`),D.open(),M=!0),se(xt,`RPC '${e}' stream ${a} sending:`,J),D.send(J))},Zo:()=>D.close()}),Z=(J,ye,pe)=>{J.listen(ye,(me=>{try{pe(me)}catch(ke){setTimeout((()=>{throw ke}),0)}}))};return Z(D,aa.EventType.OPEN,(()=>{Q||(se(xt,`RPC '${e}' stream ${a} transport opened.`),X.o_())})),Z(D,aa.EventType.CLOSE,(()=>{Q||(Q=!0,se(xt,`RPC '${e}' stream ${a} transport closed`),X.a_(),this.E_(D))})),Z(D,aa.EventType.ERROR,(J=>{Q||(Q=!0,Vu(xt,`RPC '${e}' stream ${a} transport errored. Name:`,J.name,"Message:",J.message),X.a_(new he(W.UNAVAILABLE,"The operation could not be completed")))})),Z(D,aa.EventType.MESSAGE,(J=>{if(!Q){const ye=J.data[0];Xe(!!ye,16349);const pe=ye,me=pe?.error||pe[0]?.error;if(me){se(xt,`RPC '${e}' stream ${a} received error:`,me);const ke=me.status;let tt=(function(T){const S=it[T];if(S!==void 0)return m0(S)})(ke),Oe=me.message;tt===void 0&&(tt=W.INTERNAL,Oe="Unknown error status: "+ke+" with message "+me.message),Q=!0,X.a_(new he(tt,Oe)),D.close()}else se(xt,`RPC '${e}' stream ${a} received:`,ye),X.u_(ye)}})),Z(g,Pg.STAT_EVENT,(J=>{J.stat===Uh.PROXY?se(xt,`RPC '${e}' stream ${a} detected buffering proxy`):J.stat===Uh.NOPROXY&&se(xt,`RPC '${e}' stream ${a} detected no buffering proxy`)})),setTimeout((()=>{X.__()}),0),X}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((n=>n===e))}}function kh(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ra="RemoteStore";class dT{constructor(e,n,s,a,c){this.localStore=e,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=c,this.Aa.Oo((p=>{s.enqueueAndForget((async()=>{Pa(this)&&(se(Ra,"Restarting streams for network reachability change."),await(async function(_){const E=je(_);E.Ea.add(4),await ka(E),E.Ra.set("Unknown"),E.Ea.delete(4),await bu(E)})(this))}))})),this.Ra=new fT(s,a)}}async function bu(i){if(Pa(i))for(const e of i.da)await e(!0)}async function ka(i){for(const e of i.da)await e(!1)}function Pa(i){return je(i).Ea.size===0}async function my(i,e,n){if(!Aa(e))throw e;i.Ea.add(1),await ka(i),i.Ra.set("Offline"),n||(n=()=>eT(i.localStore)),i.asyncQueue.enqueueRetryable((async()=>{se(Ra,"Retrying IndexedDB access"),await n(),i.Ea.delete(1),await bu(i)}))}function gy(i,e){return e().catch((n=>my(i,n,e)))}async function ju(i){const e=je(i),n=ui(e);let s=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:cf;for(;pT(e);)try{const a=await tT(e.localStore,s);if(a===null){e.Ta.length===0&&n.L_();break}s=a.batchId,mT(e,a)}catch(a){await my(e,a)}yy(e)&&_y(e)}function pT(i){return Pa(i)&&i.Ta.length<10}function mT(i,e){i.Ta.push(e);const n=ui(i);n.O_()&&n.X_&&n.ea(e.mutations)}function yy(i){return Pa(i)&&!ui(i).x_()&&i.Ta.length>0}function _y(i){ui(i).start()}async function gT(i){ui(i).ra()}async function yT(i){const e=ui(i);for(const n of i.Ta)e.ea(n.mutations)}async function _T(i,e,n){const s=i.Ta.shift(),a=vf.from(s,e,n);await gy(i,(()=>i.remoteSyncer.applySuccessfulWrite(a))),await ju(i)}async function vT(i,e){e&&ui(i).X_&&await(async function(s,a){if((function(p){return p0(p)&&p!==W.ABORTED})(a.code)){const c=s.Ta.shift();ui(s).B_(),await gy(s,(()=>s.remoteSyncer.rejectFailedWrite(c.batchId,a))),await ju(s)}})(i,e),yy(i)&&_y(i)}async function Um(i,e){const n=je(i);n.asyncQueue.verifyOperationInProgress(),se(Ra,"RemoteStore received new credentials");const s=Pa(n);n.Ea.add(3),await ka(n),s&&n.Ra.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.Ea.delete(3),await bu(n)}async function ET(i,e){const n=je(i);e?(n.Ea.delete(2),await bu(n)):e||(n.Ea.add(2),await ka(n),n.Ra.set("Unknown"))}function ui(i){return i.fa||(i.fa=(function(n,s,a){const c=je(n);return c.sa(),new uT(s,c.connection,c.authCredentials,c.appCheckCredentials,c.serializer,a)})(i.datastore,i.asyncQueue,{Xo:()=>Promise.resolve(),t_:gT.bind(null,i),r_:vT.bind(null,i),ta:yT.bind(null,i),na:_T.bind(null,i)}),i.da.push((async e=>{e?(i.fa.B_(),await ju(i)):(await i.fa.stop(),i.Ta.length>0&&(se(Ra,`Stopping write stream with ${i.Ta.length} pending writes`),i.Ta=[]))}))),i.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ci="FirestoreClient";class DT{constructor(e,n,s,a,c){this.authCredentials=e,this.appCheckCredentials=n,this.asyncQueue=s,this.databaseInfo=a,this.user=Ot.UNAUTHENTICATED,this.clientId=of.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=c,this.authCredentials.start(s,(async p=>{se(ci,"Received user=",p.uid),await this.authCredentialListener(p),this.user=p})),this.appCheckCredentials.start(s,(p=>(se(ci,"Received new app check token=",p),this.appCheckCredentialListener(p,this.user))))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new Bi;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(n){const s=vy(n,"Failed to shutdown persistence");e.reject(s)}})),e.promise}}async function Ph(i,e){i.asyncQueue.verifyOperationInProgress(),se(ci,"Initializing OfflineComponentProvider");const n=i.configuration;await e.initialize(n);let s=n.initialUser;i.setCredentialChangeListener((async a=>{s.isEqual(a)||(await dy(e.localStore,a),s=a)})),e.persistence.setDatabaseDeletedListener((()=>i.terminate())),i._offlineComponents=e}async function Bm(i,e){i.asyncQueue.verifyOperationInProgress();const n=await xT(i);se(ci,"Initializing OnlineComponentProvider"),await e.initialize(n,i.configuration),i.setCredentialChangeListener((s=>Um(e.remoteStore,s))),i.setAppCheckTokenChangeListener(((s,a)=>Um(e.remoteStore,a))),i._onlineComponents=e}async function xT(i){if(!i._offlineComponents)if(i._uninitializedComponentsProvider){se(ci,"Using user provided OfflineComponentProvider");try{await Ph(i,i._uninitializedComponentsProvider._offline)}catch(e){const n=e;if(!(function(a){return a.name==="FirebaseError"?a.code===W.FAILED_PRECONDITION||a.code===W.UNIMPLEMENTED:!(typeof DOMException<"u"&&a instanceof DOMException)||a.code===22||a.code===20||a.code===11})(n))throw n;Vu("Error using user provided cache. Falling back to memory cache: "+n),await Ph(i,new Au)}}else se(ci,"Using default OfflineComponentProvider"),await Ph(i,new NT(void 0));return i._offlineComponents}async function OT(i){return i._onlineComponents||(i._uninitializedComponentsProvider?(se(ci,"Using user provided OnlineComponentProvider"),await Bm(i,i._uninitializedComponentsProvider._online)):(se(ci,"Using default OnlineComponentProvider"),await Bm(i,new Qh))),i._onlineComponents}function VT(i){return OT(i).then((e=>e.syncEngine))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qm="AsyncQueue";class Gm{constructor(e=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new py(this,"async_queue_retry"),this._c=()=>{const s=kh();s&&se(qm,"Visibility state changed to "+s.visibilityState),this.M_.w_()},this.ac=e;const n=kh();n&&typeof n.addEventListener=="function"&&n.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const n=kh();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise((()=>{}));const n=new Bi;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(e().then(n.resolve,n.reject),n.promise))).then((()=>n.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.Xu.push(e),this.lc())))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(e){if(!Aa(e))throw e;se(qm,"Operation failed with retryable error: "+e)}this.Xu.length>0&&this.M_.p_((()=>this.lc()))}}cc(e){const n=this.ac.then((()=>(this.rc=!0,e().catch((s=>{throw this.nc=s,this.rc=!1,Gi("INTERNAL UNHANDLED ERROR: ",Km(s)),s})).then((s=>(this.rc=!1,s))))));return this.ac=n,n}enqueueAfterDelay(e,n,s){this.uc(),this.oc.indexOf(e)>-1&&(n=0);const a=If.createAndSchedule(this,e,n,s,(c=>this.hc(c)));return this.tc.push(a),a}uc(){this.nc&&ve(47125,{Pc:Km(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ic(e){for(const n of this.tc)if(n.timerId===e)return!0;return!1}Ec(e){return this.Tc().then((()=>{this.tc.sort(((n,s)=>n.targetTimeMs-s.targetTimeMs));for(const n of this.tc)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.Tc()}))}dc(e){this.oc.push(e)}hc(e){const n=this.tc.indexOf(e);this.tc.splice(n,1)}}function Km(i){let e=i.message||"";return i.stack&&(e=i.stack.includes(i.message)?i.stack:i.message+`
`+i.stack),e}class Sy extends Sf{constructor(e,n,s,a){super(e,n,s,a),this.type="firestore",this._queue=new Gm,this._persistenceKey=a?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Gm(e),this._firestoreClient=void 0,await e}}}function UT(i,e){const n=typeof i=="object"?i:Sg(),s=typeof i=="string"?i:yu,a=nf(n,"firestore").getImmediate({identifier:s});if(!a._initialized){const c=Ov("firestore");c&&LT(a,...c)}return a}function FT(i){if(i._terminated)throw new he(W.FAILED_PRECONDITION,"The client has already been terminated.");return i._firestoreClient||bT(i),i._firestoreClient}function bT(i){const e=i._freezeSettings(),n=(function(a,c,p,g){return new Ow(a,c,p,g.host,g.ssl,g.experimentalForceLongPolling,g.experimentalAutoDetectLongPolling,Ty(g.experimentalLongPollingOptions),g.useFetchStreams,g.isUsingEmulator)})(i._databaseId,i._app?.options.appId||"",i._persistenceKey,e);i._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(i._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),i._firestoreClient=new DT(i._authCredentials,i._appCheckCredentials,i._queue,n,i._componentsProvider&&(function(a){const c=a?._online.build();return{_offline:a?._offline.build(c),_online:c}})(i._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class On{constructor(e){this._byteString=e}static fromBase64String(e){try{return new On(Jn.fromBase64String(e))}catch(n){throw new he(W.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new On(Jn.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:On._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Sa(e,On._jsonSchema))return On.fromBase64String(e.bytes)}}On._jsonSchemaVersion="firestore/bytes/1.0",On._jsonSchema={type:st("string",On._jsonSchemaVersion),bytes:st("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new he(W.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new he(W.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return xe(this._lat,e._lat)||xe(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Er._jsonSchemaVersion}}static fromJSON(e){if(Sa(e,Er._jsonSchema))return new Er(e.latitude,e.longitude)}}Er._jsonSchemaVersion="firestore/geoPoint/1.0",Er._jsonSchema={type:st("string",Er._jsonSchemaVersion),latitude:st("number"),longitude:st("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xy{constructor(e,n,s,a,c){this._firestore=e,this._userDataWriter=n,this._key=s,this._document=a,this._converter=c}get id(){return this._key.path.lastSegment()}get ref(){return new Lt(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new KT(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const n=this._document.data.field(Oy("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n)}}}class KT extends xy{data(){return super.data()}}function Oy(i,e){return typeof e=="string"?Dy(i,e):e instanceof Cf?e._internalPath:e._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zm(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Wy(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(By(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Gy(e))return"Blackberry";if(Ky(e))return"Webos";if($y(e))return"Safari";if((e.includes("chrome/")||Hy(e))&&!e.includes("edge/"))return"Chrome";if(qy(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=i.match(n);if(s?.length===2)return s[1]}return"Other"}function By(i=Mt()){return/firefox\//i.test(i)}function $y(i=Mt()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Hy(i=Mt()){return/crios\//i.test(i)}function Wy(i=Mt()){return/iemobile/i.test(i)}function qy(i=Mt()){return/android/i.test(i)}function Gy(i=Mt()){return/blackberry/i.test(i)}function Ky(i=Mt()){return/webos/i.test(i)}function xf(i=Mt()){return/iphone|ipad|ipod/i.test(i)||/macintosh/i.test(i)&&/mobile/i.test(i)}function gI(i=Mt()){return xf(i)&&!!window.navigator?.standalone}function yI(){return $v()&&document.documentMode===10}function Qy(i=Mt()){return xf(i)||qy(i)||Ky(i)||Gy(i)||/windows phone/i.test(i)||Wy(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Of={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function II(i){Of=i}function SI(i){return Of.loadJS(i)}function AI(){return Of.gapiScript}function CI(i){return`__${i}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RI(i,e){const n=nf(i,"auth");if(n.isInitialized()){const a=n.getImmediate(),c=n.getOptions();if(Hi(c,e??{}))return a;Sr(a,"already-initialized")}return n.initialize({options:e})}function kI(i,e){const n=e?.persistence||[],s=(Array.isArray(n)?n:[n]).map(_r);e?.errorMap&&i._updateErrorMap(e.errorMap),i._initializeWithPersistence(s,e?.popupRedirectResolver)}function PI(i,e,n){const s=xa(i);de(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const a=!1,c=Jy(e),{host:p,port:g}=NI(e),_=g===null?"":`:${g}`,E={url:`${c}//${p}${_}/`},C=Object.freeze({host:p,port:g,protocol:c.replace(":",""),options:Object.freeze({disableWarnings:a})});if(!s._canInitEmulator){de(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),de(Hi(E,s.config.emulator)&&Hi(C,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=E,s.emulatorConfig=C,s.settings.appVerificationDisabledForTesting=!0,so(p)?(vg(`${c}//${p}${_}`),Eg("Auth",!0)):DI()}function Jy(i){const e=i.indexOf(":");return e<0?"":i.substr(0,e+1)}function NI(i){const e=Jy(i),n=/(\/\/)?([^?#/]+)/.exec(i.substr(e.length));if(!n)return{host:"",port:null};const s=n[2].split("@").pop()||"",a=/^(\[[^\]]+\])(:|$)/.exec(s);if(a){const c=a[1];return{host:c,port:tg(s.substr(c.length+1))}}else{const[c,p]=s.split(":");return{host:c,port:tg(p)}}}function tg(i){if(!i)return null;const e=Number(i);return isNaN(e)?null:e}function DI(){function i(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",i):i())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oa extends Zy{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ei extends Oa{constructor(){super("facebook.com")}static credential(e){return Xi._fromParams({providerId:ei.PROVIDER_ID,signInMethod:ei.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ei.credentialFromTaggedObject(e)}static credentialFromError(e){return ei.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ei.credential(e.oauthAccessToken)}catch{return null}}}ei.FACEBOOK_SIGN_IN_METHOD="facebook.com";ei.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni extends Oa{constructor(){super("github.com")}static credential(e){return Xi._fromParams({providerId:ni.PROVIDER_ID,signInMethod:ni.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ni.credentialFromTaggedObject(e)}static credentialFromError(e){return ni.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ni.credential(e.oauthAccessToken)}catch{return null}}}ni.GITHUB_SIGN_IN_METHOD="github.com";ni.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function OI(i,e){return Nf(i,"POST","/v1/accounts:signUp",Da(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function VI(i){if(mn(i.app))return Promise.reject(Tr(i));const e=xa(i);if(await e._initializationPromise,e.currentUser?.isAnonymous)return new Cr({user:e.currentUser,providerId:null,operationType:"signIn"});const n=await OI(e,{returnSecureToken:!0}),s=await Cr._fromIdTokenResponse(e,"signIn",n,!0);return await e._updateCurrentUser(s.user),s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R1=new Na(5e3,15e3),k1="__/auth/iframe",P1="emulator/auth/iframe",N1={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},D1=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function x1(i){const e=i.config;de(e.authDomain,i,"auth-domain-config-required");const n=e.emulator?Pf(e,P1):`https://${i.config.authDomain}/${k1}`,s={apiKey:e.apiKey,appName:i.name,v:oo},a=D1.get(i.config.apiHost);a&&(s.eid=a);const c=i._getFrameworks();return c.length&&(s.fw=c.join(",")),`${n}?${Ia(s).slice(1)}`}async function O1(i){const e=await C1(i),n=Xn().gapi;return de(n,i,"internal-error"),e.open({where:document.body,url:x1(i),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:N1,dontclear:!0},s=>new Promise(async(a,c)=>{await s.restyle({setHideOnLeave:!1});const p=Qn(i,"network-request-failed"),g=Xn().setTimeout(()=>{c(p)},R1.get());function _(){Xn().clearTimeout(g),a(s)}s.ping(_).then(_,()=>{c(p)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dh="webStorageSupport";class W1{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=i_,this._completeRedirectFn=m1,this._overrideRedirectResult=f1}async _openPopup(e,n,s,a){Ar(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const c=await lg(e,n,s,Xh(),a);return b1(e,c,Vf())}async _openRedirect(e,n,s,a){await this._originValidation(e);const c=await lg(e,n,s,Xh(),a);return KI(c),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:a,promise:c}=this.eventManagers[n];return a?Promise.resolve(a):(Ar(c,"If manager is not set, promise should be"),c)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await O1(e),s=new y1(e);return n.register("authEvent",a=>(de(a?.authEvent,e,"invalid-auth-event"),{status:s.onEvent(a.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Dh,{type:Dh},a=>{const c=a?.[0]?.[Dh];c!==void 0&&n(!!c),Sr(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=T1(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return Qy()||$y()||xf()}}const q1=W1;var ug="@firebase/auth",cg="1.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X1=300,J1=_g("authIdTokenMaxAge")||X1;let hg=null;const Y1=i=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>J1)return;const a=n?.token;hg!==a&&(hg=a,await fetch(i,{method:a?"POST":"DELETE",headers:a?{Authorization:`Bearer ${a}`}:{}}))};function Z1(i=Sg()){const e=nf(i,"auth");if(e.isInitialized())return e.getImmediate();const n=RI(i,{popupRedirectResolver:q1,persistence:[r1,WI,i_]}),s=_g("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const c=new URL(s,location.origin);if(location.origin===c.origin){const p=Y1(c.toString());zI(n,p,()=>p(n.currentUser)),jI(n,g=>p(g))}}const a=gg("auth");return a&&PI(n,`http://${a}`),n}function eS(){return document.getElementsByTagName("head")?.[0]??document}II({loadJS(i){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=a=>{const c=Qn("internal-error");c.customData=a,n(c)},s.type="text/javascript",s.charset="UTF-8",eS().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Q1("Browser");const tS=typeof __app_id<"u"?__app_id:"default-app-id",fg=typeof __initial_auth_token<"u"?__initial_auth_token:null;function nS(){const[i,e]=ji.useState(""),[n,s]=ji.useState(""),[a,c]=ji.useState(!1),[p,g]=ji.useState(null);ji.useEffect(()=>{try{const E={apiKey:"AIzaSyCvhDJUU3IFZ_ZCkS6_YTE7CYRugSvwnJ0",authDomain:"picstronaute-email-base.firebaseapp.com",projectId:"picstronaute-email-base",storageBucket:"picstronaute-email-base.firebasestorage.app",messagingSenderId:"705721731833",appId:"1:705721731833:web:b991d936eb98c98f31f028",measurementId:"G-ZLDKNNR6JG"};if(!E.apiKey||!E.projectId){console.error("Erreur: Configuration Firebase incomplète. Veuillez vérifier les variables d'environnement."),s("Erreur de connexion à la base de données. Veuillez réessayer plus tard.");return}const C=Ig(E),D=UT(C);g(D);const M=Z1(C),Q=BI(M,async X=>{if(!X)try{fg?await bI(M,fg):await VI(M)}catch(Z){console.error("Erreur de connexion Firebase:",Z)}});return()=>Q()}catch(E){console.error("Erreur d'initialisation de Firebase:",E)}},[]);const _=async E=>{if(E.preventDefault(),!i||!p){s("Erreur de connexion à la base de données. Veuillez réessayer plus tard.");return}c(!0);try{const C=MT(p,`/artifacts/${tS}/public/data/emails`,i);await JT(C,{email:i,timestamp:new Date}),s("Merci ! Votre email a bien été enregistré."),e("")}catch(C){console.error("Erreur d'enregistrement de l'email:",C),s("Une erreur est survenue. Veuillez réessayer.")}finally{c(!1)}};return G.jsxs("div",{className:"email-form-container",children:[G.jsx("h3",{children:"Tout sur le lancement !"}),G.jsx("p",{children:"Soyez les premiers informés des missions exclusives, des nouvelles fonctionnalités et du lancement de l'application."}),G.jsxs("form",{onSubmit:_,className:"cta-form",children:[G.jsx("input",{type:"email",name:"email",placeholder:"Votre adresse email",required:!0,value:i,onChange:E=>e(E.target.value),disabled:a}),G.jsx("button",{type:"submit",disabled:a,children:a?"En cours...":"Rejoindre l'aventure"})]}),n&&G.jsx("p",{className:"form-message",children:n})]})}function rS(){return G.jsxs(G.Fragment,{children:[G.jsx("section",{className:"hero-section",children:G.jsx("div",{className:"hero-content",children:G.jsxs("div",{className:"hero-text-column",children:[G.jsx("h2",{children:"Pour que chaque photo devienne une aventure."}),G.jsx("p",{children:"Des défis créatifs pour bouger, explorer et capturer le monde autrement, entre amis ou avec la communauté."}),G.jsx("a",{href:"#email",className:"cta-button",children:"Rejoindre l'aventure"})]})})}),G.jsxs("section",{id:"concept",className:"features-section",children:[G.jsx("h3",{children:"Le concept en 4 points :"}),G.jsxs("div",{className:"features-container",children:[G.jsxs("div",{className:"feature-item-bouger",children:[G.jsx("h4",{children:"Bouger"}),G.jsx("p",{children:"Des défis photo qui vous incitent à l'action. Marchez, courez, pédalez pour trouver le cliché parfait."})]}),G.jsxs("div",{className:"feature-item-explorer",children:[G.jsx("h4",{children:"Explorer"}),G.jsx("p",{children:"Découvrez votre environnement, des rues de votre quartier aux sentiers de randonnée."})]}),G.jsxs("div",{className:"feature-item-capturer",children:[G.jsx("h4",{children:"Capturer"}),G.jsx("p",{children:"Immortalisez vos aventures. Avec votre smartphone ou votre reflex, transformer l'instant en image."})]}),G.jsxs("div",{className:"feature-item-defier",children:[G.jsx("h4",{children:"Défier"}),G.jsx("p",{children:"Relevez ou créer vos défis, grimpez dans le classement et gagnez les challenges. Chaque photo est une chance de vous dépasser."})]})]})]}),G.jsx("section",{id:"email",children:G.jsx(nS,{})}),G.jsxs("section",{id:"defis",className:"feature-challenge",children:[G.jsx("h3",{children:"En attendant l'application, participe à nos défis !"}),G.jsxs("p",{children:["Retrouve les derniers challenges photo et partage tes créations sur Instagram avec ",G.jsx("a",{href:"https://www.instagram.com/explore/tags/ChallengePicstronaute",target:"_blank",rel:"noopener noreferrer",children:"#ChallengePicstronaute"}),"."]}),G.jsxs("div",{className:"challenges-container",children:[G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/1.png",alt:"Défi 1"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/2.png",alt:"Défi 2"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/3.png",alt:"Défi 3"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/4.png",alt:"Défi 4"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/5.png",alt:"Défi 5"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/6.png",alt:"Défi 6"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/7.png",alt:"Défi 7"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/8.png",alt:"Défi 8"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/9.png",alt:"Défi 9"})}),G.jsx("div",{className:"challenge-card",children:G.jsx("img",{src:"images/Defis/10.png",alt:"Défi 10"})})]}),G.jsx("div",{className:"instagram-button",children:G.jsx("a",{href:"https://instagram.com/picstronaute",target:"_blank",className:"cta-button instagram-button",children:"Voir plus de défis sur Instagram"})})]})]})}function iS(){return G.jsxs("div",{className:"landing-page-container",children:[G.jsx(Iv,{}),G.jsx("main",{className:"main-content",children:G.jsx(rS,{})}),G.jsx(Sv,{})]})}Tv.createRoot(document.getElementById("root")).render(G.jsx(ji.StrictMode,{children:G.jsx(iS,{})}));
